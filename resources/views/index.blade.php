        ...
        "loop": true
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="overflow-hidden position-relative h-100">
                        <div class="slideshow-character position-absolute bottom-0 pos_right-center">
                            <img loading="lazy" src="{{ 'assets/images/slideshow-character1.png' }}" width="400"
                                height="733" alt="Woman Fashion 1"
                                class="slideshow-character__img animate animate_fade animate_btt animate_delay-9 w-auto h-auto" />
                ...
                <div class="swiper-slide">
                    <div class="overflow-hidden position-relative h-100">
                        <div class="slideshow-character position-absolute bottom-0 pos_right-center">
                            <img loading="lazy" src="{{ 'assets/images/slideshow-character2.png' }}" width="400"
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img loading="lazy" class="w-100 h-auto mb-3"
                                    src="{{ 'assets/images/home/demo3/category_1.png' }}" width="124" height="124"
                                    alt="" />
                            ...
                            <div class="swiper-slide">
                                <img loading="lazy" class="w-100 h-auto mb-3"
                                    src="{{ 'assets/images/home/demo3/category_2.png' }}" width="124" height="124"
                                    alt="" />
                                <div class="text-center">
                            ...
                            <div class="swiper-slide">
                                <img loading="lazy" class="w-100 h-auto mb-3"
                                    src="{{ 'assets/images/home/demo3/category_3.png' }}" width="124" height="124"
                                    alt="" />
                                <div class="text-center">
                            ...
                            <div class="swiper-slide">
                                <img loading="lazy" class="w-100 h-auto mb-3"
                                    src="{{ 'assets/images/home/demo3/category_4.png' }}" width="124" height="124"
                                    alt="" />
                                <div class="text-center">
                            ...
                            <div class="swiper-slide">
                                <img loading="lazy" class="w-100 h-auto mb-3"
                                    src="{{ 'assets/images/home/demo3/category_5.png' }}" width="124" height="124"
                                    alt="" />
                                <div class="text-center">
                            ...
                            <div class="swiper-slide">
                                <img loading="lazy" class="w-100 h-auto mb-3"
                                    src="{{ 'assets/images/home/demo3/category_6.png' }}" width="124" height="124"
                                    alt="" />
                                <div class="text-center">
                            ...
                            <div class="swiper-slide">
                                <img loading="lazy" class="w-100 h-auto mb-3"
                                    src="{{ 'assets/images/home/demo3/category_7.png' }}" width="124" height="124"
                                    alt="" />
                                <div class="text-center">
                            ...
                            <div class="swiper-slide">
                                <img loading="lazy" class="w-100 h-auto mb-3"
                                    src="{{ 'assets/images/home/demo3/category_8.png' }}" width="124" height="124"
                                    alt="" />
                                <div class="text-center">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide product-card product-card_style3">
                                        <div class="pc__img-wrapper">
                                            <a href="details.html">
                                                <img loading="lazy"
                                                    src="{{ 'assets/images/home/demo3/product-0-1.jpg' }}" width="258"
                                                    height="313" alt="Cropped Faux leather Jacket" class="pc__img">
                                                <img loading="lazy"
                                                    src="{{ 'assets/images/home/demo3/product-0-2.jpg' }}" width="258"
                                    ...
                                    <div class="swiper-slide product-card product-card_style3">
                                        <div class="pc__img-wrapper">
                                            <a href="details.html">
                                                <img loading="lazy"
                                                    src="{{ 'assets/images/home/demo3/product-1-1.jpg' }}" width="258"
                                                    height="313" alt="Cropped Faux leather Jacket" class="pc__img">
                                                <img loading="lazy"
                                                    src="{{ 'assets/images/home/demo3/product-1-2.jpg' }}" width="258"
                                                    height="313" alt="Cropped Faux leather Jacket"
                                                    class="pc__img pc__img-second">
                                            </a>
                                        </div>
                                    ...
                                    <div class="swiper-slide product-card product-card_style3">
                                        <div class="pc__img-wrapper">
                                            <a href="details.html">
                                                <img loading="lazy"
                                                    src="{{ 'assets/images/home/demo3/product-2-1.jpg' }}" width="258"
                                                    height="313" alt="Cropped Faux leather Jacket" class="pc__img">
                                                <img loading="lazy"
                                                    src="{{ 'assets/images/home/demo3/product-2-2.jpg' }}" width="258"
                                                    height="313" alt="Cropped Faux leather Jacket"
                                                    class="pc__img pc__img-second">
                                            </a>
                                        </div>
                                    ...
                                    <div class="swiper-slide product-card product-card_style3">
                                        <div class="pc__img-wrapper">
                                            <a href="details.html">
                                                <img loading="lazy"
                                                    src="{{ 'assets/images/home/demo3/product-3-1.jpg' }}" width="258"
                                                    height="313" alt="Cropped Faux leather Jacket" class="pc__img">
                                                <img loading="lazy"
                                                    src="{{ 'assets/images/home/demo3/product-3-2.jpg' }}" width="258"
                                                    height="313" alt="Cropped Faux leather Jacket"
                                                    class="pc__img pc__img-second">
                                            </a>
                                        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="category-banner__item border-radius-10 mb-5">
                            <img loading="lazy" class="h-auto" src="{{ 'assets/images/home/demo3/category_9.jpg' }}"
                ...
                <div class="row">
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
                            <div class="pc__img-wrapper">
                                <a href="details.html">
                                    <img loading="lazy" src="{{ 'assets/images/home/demo3/product-4.jpg' }}"
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
                            <div class="pc__img-wrapper">
                                <a href="details.html">
                                    <img loading="lazy" src="{{ 'assets/images/home/demo3/product-5.jpg' }}"
                                        width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img">
                                </a>
                            </div>
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
                            <div class="pc__img-wrapper">
                                <a href="details.html">
                                    <img loading="lazy" src="{{ 'assets/images/home/demo3/product-6.jpg' }}"
                                        width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img">
                                </a>
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
                            <div class="pc__img-wrapper">
                                <a href="details.html">
                                    <img loading="lazy" src="{{ 'assets/images/home/demo3/product-7.jpg' }}"
                                        width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img">
                                </a>
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
                            <div class="pc__img-wrapper">
                                <a href="details.html">
                                    <img loading="lazy" src="{{ 'assets/images/home/demo3/product-8.jpg' }}"
                                        width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img">
                                </a>
                            </div>
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
                            <div class="pc__img-wrapper">
                                <a href="details.html">
                                    <img loading="lazy" src="{{ 'assets/images/home/demo3/product-9.jpg' }}"
                                        width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img">
                                </a>
                            </div>
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
                            <div class="pc__img-wrapper">
                                <a href="details.html">
                                    <img loading="lazy" src="{{ 'assets/images/home/demo3/product-10.jpg' }}"
                                        width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img">
                                </a>
                            </div>
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
                            <div class="pc__img-wrapper">
                                <a href="details.html">
                                    <img loading="lazy" src="{{ 'assets/images/home/demo3/product-11.jpg' }}"
                                        width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img">
                                </a>
                            </div>
